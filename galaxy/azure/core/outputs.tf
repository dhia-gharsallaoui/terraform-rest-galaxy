output "azure_values" {
  ...
  value = { for k, v in {
    ...
    azure_storage_account_file_shares                 = module.azure_storage_account_file_shares
    azure_storage_account_queues                      = module.azure_storage_account_queues
    azure_storage_account_tables                      = module.azure_storage_account_tables
    azure_storage_account_management_policies         = module.azure_storage_account_management_policies
    azure_storage_account_encryption_scopes           = module.azure_storage_account_encryption_scopes
    azure_storage_account_local_users                 = module.azure_storage_account_local_users
    azure_storage_account_object_replication_policies = module.azure_storage_account_object_replication_policies
    azure_storage_account_inventory_policies          = module.azure_storage_account_inventory_policies
    azure_storage_account_blobs                       = module.azure_storage_account_blobs
